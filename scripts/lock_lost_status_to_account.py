...
if old_intro not in s:
    raise SystemExit("No encontré el texto introductorio")
...
if old_status not in s:
    raise SystemExit("No encontré el selector de estado")
...
if old_assign not in s:
    raise SystemExit("No encontré el payload del editor")
